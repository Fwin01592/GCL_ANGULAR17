...
export class PrimiumCalculationComponent implements OnInit{
  ...
  schema={
    ...
    personalDetail:[
      ...
      { name: 'mobileNumber', label: 'Mobile Number', type: 'phone', required: true },
      { name: 'primaryLifeOccupation', label: 'Primary Life Occupation', type: 'select', options: [{ value: 'agriculture', key: 'Agriculture' }, { value: 'business', key: 'Business' }, { value: 'selfEmployed', key: 'Self Employed' }, { value: 'others', key: 'Others' }, { value: 'professional', key: 'Professional' }, { value: 'service', key: 'Service' }, { value: 'bobStaff', key: 'BOB staff' }] , required: true},
